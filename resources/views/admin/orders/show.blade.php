...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($order->notes)
                <div class="bg-surface-card border border-surface-border rounded-xl p-6 mt-6">
                    <div class="flex items-center gap-2 mb-2">
                        <svg class="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
                        </svg>
                        <h3 class="text-gray-900 font-semibold">Catatan / Pesan Pembeli</h3>
                    </div>
                    <p class="text-gray-600 text-sm bg-surface p-4 rounded-lg border border-surface-border font-medium italic">
                        "{{ $order->notes }}"
                    </p>
                </div>
            @endif
